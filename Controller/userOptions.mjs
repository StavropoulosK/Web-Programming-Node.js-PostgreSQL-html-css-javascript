...
function kritikiTime(check_In){
    //o pelatis mporei na grapsi kritiki apo ti mera  tou checkIn
...
async function showKratisis(req,res,next){
...
async function writeKritiki(req,res,next){
    try {
...
async function akirosiKratisis(req,res,next){
    try {
        const checkIn=req.body.checkIn
        const checkOut=req.body.checkOut
        const roomNumber=Number(req.body.roomNumber)
...
async function makeNextBookPayment(req,res,next){
...
async function displayNextBookPayment(req,res,next){
